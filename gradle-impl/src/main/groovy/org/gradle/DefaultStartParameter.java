...
/**
 * <p>{@code StartParameter} defines the configuration used by a {@link DefaultGradle} instance to execute a build. The
 * properties of {@code StartParameter} generally correspond to the command-line options of Gradle. You pass a {@code
 * StartParameter} instance to {@link DefaultGradle#newInstance(org.gradle.StartParameter)} when you create a new {@code Gradle}
 * instance.</p>
 *
 ...
 * @see DefaultGradle
 */
public class DefaultStartParameter implements StartParameter {
    ...
    DefaultStartParameter(String settingsFileName, String buildFileName, List<String> taskNames, File currentDir,
                          ...
                          File pluginPropertiesFile, CacheUsage cacheUsage, String logLevel) {
