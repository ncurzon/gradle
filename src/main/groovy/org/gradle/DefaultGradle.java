 ...
 * #addBuildListener}.</li>
 *
 * <li>Call {@link #run} to execute the build. This will return a {@link DefaultBuildResult}. Note that if the build fails, the
 * resulting exception will be contained in the {@code BuildResult}.</li>
 *
 * <li>Query the build result. You might want to call {@link DefaultBuildResult#rethrowFailure()} to rethrow any build
 * failure.</li>
 *
 * </ol>
 *
...
public class DefaultGradle implements Gradle {
     ...
     * exception is available using {@link DefaultBuildResult#getFailure()}.</p>
     *
