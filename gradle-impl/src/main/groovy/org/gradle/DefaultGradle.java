 ...
 * <ol>
 *
 * <li>Create a {@link DefaultStartParameter} instance and configure it with the desired properties. The properties of {@code
 ...
 *
 * <li>Optionally, add one or more {@link org.gradle.BuildListener}s to receive events as the build executes by calling {@link
 * #addBuildListener}.</li>
 *
 * <li>Call {@link #run} to execute the build. This will return a {@link org.gradle.DefaultBuildResult}. Note that if the build fails, the
 * resulting exception will be contained in the {@code BuildResult}.</li>
 *
 * <li>Query the build result. You might want to call {@link org.gradle.DefaultBuildResult#rethrowFailure()} to rethrow any build
 * failure.</li>
 *
 * </ol>
 *
 * @author Hans Dockter
 */
public class DefaultGradle implements Gradle {
    private static Logger logger = LoggerFactory.getLogger(DefaultGradle.class);
    ...
    public DefaultGradle(StartParameter startParameter, ISettingsFinder settingsFinder,
     ...
     * exception is available using {@link org.gradle.DefaultBuildResult#getFailure()}.</p>
     *
    ...
    public BuildResult run() {
        ...
        BuildResult buildResult = new DefaultBuildResult(settings, failure);
