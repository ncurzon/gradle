...
/**
 * <p>A {@code DefaultBuildResult} packages up the results of a build executed by a {@link DefaultGradle} instance.</p>
 */
public class DefaultBuildResult implements BuildResult {
    private final Settings settings;
    private final Throwable failure;

    public DefaultBuildResult(Settings settings, Throwable failure) {
